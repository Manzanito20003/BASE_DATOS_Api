    ...
    try:
        ...
        with psycopg2.connect(host=host, database=database, user=user, password=password) as conexion:
            with conexion.cursor() as cursor:
                ...
                tree.column("Cédula", anchor=tk.W, width=100)
                ...
                tree.column("Edad", anchor=tk.W, width=50)

                # Encabezados de las columnas
                tree.heading("#0", text="", anchor=tk.W)
                tree.heading("Cédula", text="Cédula", anchor=tk.W)
                ...
                tree.heading("Edad", text="Edad", anchor=tk.W)
